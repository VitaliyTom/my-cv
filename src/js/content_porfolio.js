export const contentPortfolio = {
	js: {
        ...
        <p class="date">10.2020 - 12.2020</p>
    </div>
    <li class="developing-li">
        <span class="course">Work examples:</span>
        ...
        <ul class="developing-ul">
            ...
            <li>
                <a href="https://vitaliytom.github.io/codejam-virtual-keyboard" target="_blank"
                    rel="noopener noreferrer">Virtual keyboard</a>
            </li>
            <li>
    ...
    <p class="responsive_web_design_description">*RWD - responsive web design</p>
        `,
		frontEnd: `<p class="position">
        JavaScript / Front-end Developer</p>`
	},
    ...
    <li class="developing-li">
        <span class="course">
            ...
            <a href="https://teachmeskills.by/kursy-programmirovaniya/obuchenie-java-minsk" class="teach_me_skills" id="teach_me_skills" target="_blank" rel="noopener noreferrer">&lt;TeachMeSkills/&gt;</a>
        </span>
        <ul class="developing-ul">
            <li>
